...
namespace App\Facades {
    ...
    class WeatherFacade {
         ...
         * @static
         */
        public static function result($city, $latitude, $longitude, $date)
        {
            /** @var \App\Services\WeatherService $instance */
            return $instance->result($city, $latitude, $longitude, $date);
        }
...
namespace  {
    ...
    class WeatherService extends \App\Facades\WeatherFacade {}
}
